...
%    The purpose was to plot the GPS positions in real time and save it in a log file using CSV format (data separated using a comma delimiter).
%
% Requirements:
%
...
%     - If program freezes, sometimes the data is not saved properly.
%
